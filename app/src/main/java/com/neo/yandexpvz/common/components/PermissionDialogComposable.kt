...
import com.neo.yandexpvz.common.ext.alertDialog
import com.neo.yandexpvz.common.ext.textButton
import com.neo.yandexpvz.ui.theme.OrangeDarkColor
import com.neo.yandexpvz.R.string as AppText
...
fun PermissionDialog(onRequestPermission: () -> Unit) {
    ...
    if (showWarningDialog) {
        AlertDialog(
            ...
            title = { Text(stringResource(id = AppText.notification_permission_title), fontWeight = FontWeight.Medium) },
    ...
    if (showWarningDialog) {
        AlertDialog(
            ...
            confirmButton = {
                ...
                ) { Text(text = stringResource(AppText.yes)) }
            },
